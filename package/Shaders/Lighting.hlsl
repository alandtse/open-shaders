...
#		endif
	...
	float puddleWaterBodyMask = smoothstep(puddleWaterBodyStart, max(puddleWaterBodyStart + 1e-3, puddleWaterFull), puddleSpecularBaseSaturated) * lerp(0.75, 1.0, deepPuddleMask);
