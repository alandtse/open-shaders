...
#		endif
	...
	float postRainBoostT = postRainShineBoostT;
	...
	postRainOverridePhase = saturate(postRainBlend * smoothstep(0.30, 0.88, deepPuddleMask));
	...
	// Clarity slider endpoint behavior:
