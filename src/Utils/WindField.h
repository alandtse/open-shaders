...
namespace WindField
{
	...
	struct WindTuning
	{
		...
		float advectionUnitsPerSecond{ 384.0f };
		...
		float gustMinimum{ 0.65f };
		float gustMaximum{ 1.35f };
	 ...
	 * @param a_gustTravelDistance Accumulated non-negative wind travel distance in speed-seconds.
