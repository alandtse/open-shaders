...
public:
	...
	float postRainPuddleCubemapDesaturation = 0.0f;
	float postRainPuddleSpecularBoost = 0.0f;
	float inRainPuddleCubemapSuppression = 0.0f;
	float inRainPuddleSpecularBoost = 0.0f;
