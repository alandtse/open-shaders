...
namespace NR
{
	...
	/**
	 * @brief Creation flags to drive Feature 18 with: IsHDR | DoSharpening | AutoExposure.
	 *        The SDK marks DoSharpening deprecated, but it belongs to the flag set the tested
	 *        310.8 runtime was driven with, so the deprecation is suppressed here alone.
	 */
#pragma warning(push)
#pragma warning(disable: 4996)
	inline constexpr uint32_t kFeatureFlags =
