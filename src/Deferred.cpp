...
void Deferred::DeferredPasses()
{
	...
	// Deferred Composite
	{
		...
		ID3D11ShaderResourceView* srvs[16]{
			...
			normalRoughness.SRV,
			masks.SRV,
			dynamicCubemaps.loaded || REL::Module::IsVR() ? (terrainBlending.loaded && terrainBlending.IsRuntimeEnabled() ? terrainBlending.blendedDepthTexture16->srv.get() : depth.depthSRV) : nullptr,
